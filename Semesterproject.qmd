...
Abschliesend sollte erwähnt werden, wie sensibel Mobilitätsdaten sind. Selbst in einem groben Mobilitätsdatensatz sind nur wenige externe Informationen erforderlich, um die Spur einer Zielperson zu reidentifizieren (De Montjoye et al. 2013). Daher sollte unserer Meinung nach die Verwendung von Apps, wleche Mobilitätsdaten aufnehmen, gut überlegt sein.
